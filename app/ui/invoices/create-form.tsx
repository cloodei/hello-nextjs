            ...
            <div className="flex gap-4">
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="pending"
                  className="h-4 w-4 cursor-pointer border-gray-400 bg-gray-300 text-gray-800 focus:ring-2"
              ...
              <div className="flex items-center">
                <input
                  ...
                  type="radio"
                  value="paid"
                  className="h-4 w-4 cursor-pointer border-gray-400 bg-gray-300 text-gray-700 focus:ring-2"
                  aria-describedby="status-error"
                />
                <label
                  htmlFor="paid"
